...
interface JournalingPromptsFormProps {
  onSubmit?: (formData: FormData) => Promise<void>
}

export default function JournalingPromptsForm({ onSubmit }: JournalingPromptsFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.set('category', 'journaling-prompts')
      formData.set('type', 'journaling-prompts')
    ...
    <form onSubmit={handleSubmit}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Explore your thoughts through guided prompts
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <input type="hidden" name="category" value="journaling-prompts" />
          <input type="hidden" name="type" value="journaling-prompts" />
